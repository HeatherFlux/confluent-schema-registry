...
hoistedDependencies:
  ...
  '@aws-sdk/client-sso-oidc@3.650.0(@aws-sdk/client-sts@3.650.0)':
  ...
  '@aws-sdk/lib-dynamodb@3.650.0(@aws-sdk/client-dynamodb@3.650.0)':
  ...
  '@aws-sdk/util-dynamodb@3.650.0(@aws-sdk/client-dynamodb@3.650.0)':
  ...
  '@commitlint/load@19.5.0(@types/node@22.5.4)(typescript@5.5.4)':
  ...
  '@jest/core@29.7.0(ts-node@10.9.2(@types/node@22.5.4)(typescript@5.5.4))':
    '@jest/core': private
  ...
  commitizen@4.3.0(@types/node@22.5.4)(typescript@5.5.4):
    commitizen: private
  concat-map@0.0.1:
    concat-map: private
  ...
  cosmiconfig@9.0.0(typescript@5.5.4):
    cosmiconfig: private
  create-jest@29.7.0(@types/node@22.5.4)(ts-node@10.9.2(@types/node@22.5.4)(typescript@5.5.4)):
    create-jest: private
  ...
  csv-parser@3.0.0:
    csv-parser: private
  cz-conventional-changelog@3.3.0(@types/node@22.5.4)(typescript@5.5.4):
  ...
  eslint-module-utils@2.11.0(@typescript-eslint/parser@8.2.0(eslint@8.57.0)(typescript@5.5.4))(eslint-import-resolver-node@0.3.9)(eslint@8.57.0):
  ...
  jest-circus@29.7.0:
    jest-circus: private
  jest-cli@29.7.0(@types/node@22.5.4)(ts-node@10.9.2(@types/node@22.5.4)(typescript@5.5.4)):
    jest-cli: private
  jest-config@29.7.0(@types/node@22.5.4)(ts-node@10.9.2(@types/node@22.5.4)(typescript@5.5.4)):
    jest-config: private
  jest-diff@29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Thu, 12 Sep 2024 15:29:41 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
  default: https://extend-159581800400.d.codeartifact.us-east-1.amazonaws.com/npm/extend-npm/
skipped: []
storeDir: /Users/heatherflux/Library/pnpm/store/v3
